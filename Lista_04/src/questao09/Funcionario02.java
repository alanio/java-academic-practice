...
public class Funcionario02 {
	...
	private Ponto02[] ponto = new Ponto02[31];
	
	public Funcionario02(double valorHora){
	...
	public void registrarPonto(String chegada, String saida){
		...
		ponto[totalPontos] = new Ponto02(chegadaMinutos, saidaMinutos); //cria o ponto informando o o minuto da chegada e o minuto da saida
	...
	public double calcularSalario(){
		double valorMinuto = valorHora/60; //divide o valor da hora por 60 para obter o valor do minuto
		return  getTotalMinutos() * valorMinuto;		
	}
}
